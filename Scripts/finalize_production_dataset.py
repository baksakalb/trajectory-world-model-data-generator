...
V2_THROW = pa.struct(
    [
        pa.field("sequence_template_id", pa.string()),
        pa.field("sequence_step_index", pa.int32(), nullable=False),
        pa.field("base_cell_id", pa.string(), nullable=False),
        pa.field("intended_family", pa.string(), nullable=False),
        pa.field("intended_contact_sequence", pa.string(), nullable=False),
        pa.field("preview_start_frame", pa.int32(), nullable=False),
        pa.field("authoritative_pre_throw_frame", pa.int32(), nullable=False),
        pa.field("camera_yaw", pa.float64(), nullable=False),
        pa.field("camera_pitch", pa.float64(), nullable=False),
        pa.field("aim_acquisition_profile", pa.string(), nullable=False),
        pa.field("q_rising_frame", pa.int32(), nullable=False),
        pa.field("e_edge_frame", pa.int32(), nullable=False),
        pa.field("q_to_e_steps", pa.int32(), nullable=False),
        pa.field("accepted_grenade_id", pa.int32(), nullable=False),
        pa.field("intended_target", pa.string(), nullable=False),
        pa.field("realized_target", pa.string()),
        pa.field("intended_outcome", pa.string(), nullable=False),
        ...
        pa.field("hoop_pass_frame", pa.int32()),
        ...
        pa.field("visible_event_observation_count", pa.int32(), nullable=False),
        pa.field("prescribed_movement_steps", pa.int32(), nullable=False),
        pa.field("maximum_signed_displacement_cm", pa.float32(), nullable=False),
        pa.field("geometric_crossing_pass", pa.bool_(), nullable=False),
        pa.field("q_retention_profile", pa.string(), nullable=False),
        pa.field("movement_before_next_throw", pa.string(), nullable=False),
        pa.field("camera_before_next_throw", pa.string(), nullable=False),
        pa.field("semantic_success", pa.bool_(), nullable=False),
        pa.field("credited", pa.bool_(), nullable=False),
        pa.field("preview_to_realized_flight_parity", pa.bool_(), nullable=False),
        pa.field("camera_delta_from_previous_degrees", pa.float64(), nullable=False),
        pa.field("trajectory_difference_required", pa.bool_(), nullable=False),
        pa.field("trajectory_difference_pass", pa.bool_(), nullable=False),
    ]
)
...
FRAME_SCHEMA = pa.schema(
    [
        ...
        pa.field("v2_sequence_template_id", pa.string()),
        pa.field("v2_sequence_step_index", pa.int32()),
        pa.field("v2_base_cell_id", pa.string()),
        pa.field("v2_aim_acquisition_profile", pa.string()),
        pa.field("v2_q_retention_profile", pa.string()),
        pa.field("v2_post_throw_movement_profile", pa.string()),
...
EPISODE_SCHEMA = pa.schema(
    [
        ...
        *[
        ...
        pa.field("v2_sequence_template_id", pa.string()),
        pa.field("v2_replay_identity", pa.string()),
        pa.field("v2_aim_acquisition_profile", pa.string()),
        pa.field("v2_q_retention_profile", pa.string()),
        pa.field("v2_post_throw_movement_profile", pa.string()),
        pa.field("v2_post_throw_camera_profile", pa.string()),
